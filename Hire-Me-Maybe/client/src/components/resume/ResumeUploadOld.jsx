...
import JobCustomization from "./JobCustomization";
...
const ResumeUpload = () => {
  ...
  const [activeTab, setActiveTab] = useState("analysis"); // "analysis" or "customization"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload your PDF resume for AI-powered analysis and job-specific customization
          </p>
        </div>
        ...
        {/* Tab Navigation and Content - Only show after upload */}
        {uploadedResume && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            {activeTab === "customization" && (
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Customize your resume for specific job applications. Enter job details and get an AI-optimized version.
                </p>
                <JobCustomization 
