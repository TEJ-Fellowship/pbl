...
const LandingSidebar = () => {
  ...
  return (
    <div className="h-[92vh] flex items-center justify-center gap-[1.8vw] w-[10vw]">
      ...
      {/* Horizontal Menu */}
      <div
        className={`bg-stone-700/30 h-full w-[35%] backdrop-blur-md rounded-[0.5rem] shadow-xl border border-gray-600/50 transition-all duration-200 ease-out z-50 ${
          isMenuOpen
      ...
      >
        <div className="flex flex-col h-full justify-around items-center sm:gap-2 py-2 px-2 sm:px-4">
          {/* Main Menu Items */}
          {mainMenuItems.map((item, index) => {
            if (item.name === "Others") {
              return (
                ...
                >
                  <button
                    className={`relative px-2.5 sm:px-4 transform  -rotate-90 py-1.5 sm:py-2 rounded-md text-text-dark hover:bg-gray-600/50 transition-all duration-150 whitespace-nowrap text-xs sm:text-sm ${
                      isMenuOpen
              ...
              return (
                <Link
                  ...
                  className={`px-2.5 sm:px-4 py-1.5 sm:py-2 transform -rotate-90  rounded-md text-text-dark hover:bg-gray-600/50 transition-all duration-150 whitespace-nowrap text-xs sm:text-sm ${
                    isMenuOpen
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-2"
                  } ${
