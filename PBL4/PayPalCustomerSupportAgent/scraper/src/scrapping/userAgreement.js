...
/**
 * Scrape PayPal User Agreement page
 * @param {string} url - Page URL
 * @param {string} outputFile - JSON file to save
 */
async function scrapeUserAgreement(url, outputFile) {
  ...
  console.log(`✅ User Agreement data saved to ${outputFile}`);
}
