...
import { Book, MessageCircle, Brain, TrendingUp, User, Settings, Search, Play, CheckCircle, Clock, Award } from 'lucide-react';
...
const TechMasterApp = () => {
    ...
    <div className="flex-1 p-6 overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {[
            { title: 'React Fundamentals', progress: 75, lessons: 24, duration: '8h 30m' },
            { title: 'JavaScript Advanced', progress: 45, lessons: 32, duration: '12h 15m' },
            { title: 'Node.js Backend', progress: 20, lessons: 28, duration: '10h 45m' },
            { title: 'Python for AI', progress: 90, lessons: 20, duration: '6h 20m' },
            { title: 'Database Design', progress: 60, lessons: 18, duration: '7h 10m' },
            { title: 'DevOps Essentials', progress: 30, lessons: 25, duration: '9h 30m' }
          ].map((course, index) => (
            <div key={index} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-red-500 transition-all cursor-pointer">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 text-sm">{course.progress}% complete</span>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            {[
              ...
              { action: 'Started new course', course: 'Python for AI', time: '1 day ago' },
              { action: 'Passed quiz', course: 'JavaScript Advanced', time: '2 days ago' }
            ].map((activity, index) => (
              <div key={index} className="flex items-center space-x-4 p-3 bg-gray-900 rounded-lg">
                <CheckCircle className="text-green-500" size={20} />
                <div className="flex-1">
                  <p className="text-white">{activity.action} in <span className="text-red-500">{activity.course}</span></p>
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-6 overflow-y-auto space-y-4">
        <div className="bg-gray-800 rounded-xl p-4 max-w-md">
          <p className="text-white">Hello! I'm your AI study companion. How can I help you today?</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl p-4 max-w-2xl">
          <p className="text-white mb-3">React hooks are functions that let you use state and other React features in functional components. Here are the key points:</p>
          ...
          <p className="text-white mt-3">Would you like me to explain any specific hook in detail?</p>
        </div>
      </div>
  ...
  const SmartQuizzes = () => (
    <div className="flex-1 p-6 overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Smart Quizzes</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {[
            { title: 'React Components Quiz', questions: 15, difficulty: 'Intermediate', completed: true, score: 85 },
            { title: 'JavaScript ES6 Features', questions: 20, difficulty: 'Advanced', completed: false, score: null },
            { title: 'CSS Flexbox & Grid', questions: 12, difficulty: 'Beginner', completed: true, score: 92 },
            { title: 'Node.js Fundamentals', questions: 18, difficulty: 'Intermediate', completed: false, score: null }
          ].map((quiz, index) => (
            <div key={index} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-red-500 transition-all">
              <div className="flex items-start justify-between mb-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`px-2 py-1 rounded text-xs ${
                    quiz.difficulty === 'Beginner' ? 'bg-green-900 text-green-300' :
                    quiz.difficulty === 'Intermediate' ? 'bg-yellow-900 text-yellow-300' :
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <h2 className="text-white text-xl font-semibold mb-4">Quiz Statistics</h2>
    ...
    <div className="flex-1 p-6 overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            { label: 'Courses Completed', value: '8', change: '+2', icon: CheckCircle, color: 'text-green-500' },
            { label: 'Study Hours', value: '47', change: '+5', icon: Clock, color: 'text-blue-500' },
            { label: 'Quizzes Passed', value: '23', change: '+7', icon: Brain, color: 'text-purple-500' },
            { label: 'Achievements', value: '12', change: '+1', icon: Award, color: 'text-yellow-500' }
          ].map((stat, index) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <div className="text-center">
              ...
              <div className="mt-4 flex justify-center space-x-2">
                {[...Array(7)].map((_, i) => (
                  <div key={i} className={`w-8 h-8 rounded ${i < 5 ? 'bg-red-500' : 'bg-gray-700'}`}></div>
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <h3 className="text-white text-lg font-semibold mb-4">Skills Progress</h3>
            <div className="space-y-4">
              {[
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { title: 'React Master', description: 'Completed all React courses', date: '2 days ago' },
              { title: 'Quiz Champion', description: 'Scored 90%+ on 5 quizzes', date: '1 week ago' },
              { title: 'Consistent Learner', description: '7-day learning streak', date: '2 weeks ago' }
  ...
  const renderCurrentPage = () => {
    switch(currentPage) {
      case 'learning': return <LearningPortal />;
      case 'chat': return <AIChat />;
      case 'quizzes': return <SmartQuizzes />;
      case 'progress': return <TrackProgress />;
      default: return <LearningPortal />;
    }
  };
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-800">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Your AI-powered study companion</p>
          </div>
        </div>
        <div className="flex items-center space-x-4">
