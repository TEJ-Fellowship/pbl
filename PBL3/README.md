...
- 🎙️ Record short voice notes anonymously  
...
- 🗳️ Create → vote → decide instantly  
- 🍽️ Make decisions for daily life (e.g., _“Where should we eat?”_)  
...
### 🪩 Ripple — _One Tap, Global Social Chain_

🌍 **Overview**  
Ripple is a one-button social network. Tap → ripple out → friends tap back.  
...
## 5. Mahesh Choudhary & Ganesh Choudhary

### 🎤 Sambaad — _Micro-Podcasts for Your Inner Circle_

🌍 **Overview**  
Sambaad creates a space for short voice updates.  
Instead of long podcasts or chaotic voice notes, users share **60-second clips** that build daily rhythms with friends, classes, or teams.  
It’s intimacy + structure in audio form.
...
### 🕶️ Glimpse — _One-Second Video Journals_

🌍 **Overview**  
Glimpse captures **1-second daily videos**.  
Over time, users build emotional highlight reels — short, bingeable, and memorable.
