...
export default function CanvasBoard({ brushColor, brushSize, tool, selectedShape, backgroundColor }) {
    ...
    if (tool === "shape" && startPos) {
      ...
      switch (selectedShape) {
        ...
        case "star":
          ...
          break;
        case "hexagon":
          drawHexagon(ctx, startPos.x + w/2, startPos.y +h / 2, 5, Math.abs(w) / 2, Math.abs(w) / 4);
          break;
        default:
          break;
      }
