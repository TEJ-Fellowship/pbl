...
export default function LeftSidebar({ setTool }) {
  ...
  return (
    <div className="w-16 bg-purple-400 flex flex-col items-center py-4 space-y-4 relative">
      ...
      <button
        className="p-2 hover:bg-pur-700 rounded"
      ...
      {showShapeTools && (
        <div className="absolute left-16 top-16 bg-pur-800 p-2 rounded shadow-lg flex flex-col space-y-2 z-50">
          <button
            className="p-2 hover:bg-pur-700 rounded text-white"
            onClick={() => {
              setTool("circle");
