  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          {/* SignUp Title with Logo */}
          <div className="flex items-center">
            <div
              className="w-[100px] h-[100px] bg-contain bg-no-repeat bg-center"
              style={{
          ...
          <div className="flex justify-center space-x-4">
            ...
            <button className="w-12 h-12 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:scale-110 transition-transform hover:shadow-md">
              ...
              >
                <path
                  fill="#4285F4"
                  d="M533.5 278.4c0-17.4-1.4-34.1-4.1-50.4H272v95.3h146.9c-6.3 33.7-25.3 62.3-53.9 81.5v67.5h87.2c51-47 81.3-116.2 81.3-193.9z"
                />
                <path
                  fill="#34A853"
                  d="M272 544.3c72.6 0 133.7-24.1 178.3-65.4l-87.2-67.5c-24.2 16.3-55.1 26-91.1 26-70.1 0-129.4-47.3-150.7-110.8H32.8v69.5c44.9 88.5 137.5 147.7 239.2 147.7z"
                />
                <path
                  fill="#FBBC04"
                  d="M121.3 326.6c-10.4-30.7-10.4-63.9 0-94.6v-69.5H32.8c-29.1 58.1-29.1 126.1 0 184.2l88.5-20.1z"
                />
                <path
                  fill="#EA4335"
                  d="M272 107.3c39.5-.6 77.5 13.5 106.5 39.8l79.6-79.6C413.4 23.9 344.6-1.4 272 0 170.3 0 77.7 59.2 32.8 147.7l88.5 69.5c21.3-63.5 80.6-110.8 150.7-110.8z"
                />
              </svg>
            </button>
