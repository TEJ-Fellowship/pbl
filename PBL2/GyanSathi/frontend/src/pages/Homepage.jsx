  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6 font-sans dark:from-gray-800 dark:to-gray-900 dark:text-gray-100">
      ...
      <section className="container mx-auto">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center dark:text-gray-200">
          Our Courses
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {courses.length > 0 ? (
            ...
            <p className="text-center text-gray-600 text-lg col-span-full dark:text-gray-400">
              No courses available. Please check back later or add some from the
