    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => navigate("/")} className="bg-green-100 text-green-700 px-4 py-2 rounded-md text-sm font-medium hover:bg-green-200">
            Upload Resume
          </button>
        </div>
        ...
        <div className="bg-white shadow rounded-md overflow-hidden">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-200 text-sm">
              {["Software Engineer Resume", "Product Manager Resume", "Data Analyst Resume", "Marketing Specialist Resume", "UX Designer Resume"].map(
                (title, idx) => (
                  <tr key={idx} className="hover:bg-gray-50">
                    <td className="px-6 py-4">{title}</td>
                    <td className="px-6 py-4 text-blue-600">2024-01-15</td>
