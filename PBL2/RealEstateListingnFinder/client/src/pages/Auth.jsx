...
const Auth = () => {
  ...
  const handleSignInSubmit = async (e) => {
    ...
    try {
      ...
      authLogin(userData, data.jwtToken);
      setSuccess("Sign in successful!");

      // Redirect to dashboard after successful login or to the previous page
      const redirectTo = location.state?.from?.pathname || "/UserDashboard";
  ...
  const handleGoogleSignIn = () => {
    // Google sign-in functionality can be implemented later
                  ...
                  <form onSubmit={handleSignInSubmit}>
                    ...
                    <p className="text-sm text-center text-gray-600 mt-5">
                      ...
                      <button
                        ...
                        type="button"
                        className="text-blue-600 hover:underline ml-2 cursor-pointer font-semibold transition-colors duration-200"
                      >
                        Sign up
                      </button>
                    </p>
            ...
            >
              <div className="absolute inset-0 bg-black opacity-40">
                <div className="relative text-center">
                  <h3 className="text-4xl text-yellow-200 font-bold  mt-50 pt-96">
