  ...
  const handleGemini = async () => {
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Today is "${today}". From the following events: ${JSON.stringify(
          events
        )}, list only those within the next 7 days. Include count by category (e.g., 2 Meetings), event titles, and the first upcoming event. Add a brief insight from the description and a time management tip. Keep it within 50 words.
`,
      });
