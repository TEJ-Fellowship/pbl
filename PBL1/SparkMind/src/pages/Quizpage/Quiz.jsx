    ...
    return (
        <div className='container'>
            <div className="question-card">
                ...
                <p className='topic' id='topic'>{currentItem.topic}</p>
                <hr className='underline' />

                <div className='option-container'>
                    <div className='options'>
                        <h3 className='option1' onClick={() => { answerCheck(ourOptions[0]) }}>{ourOptions[0]}</h3>
                        <h3 className='option1' onClick={() => { answerCheck(ourOptions[1]) }}>{ourOptions[1]}</h3>
                        <h3 className='option1' onClick={() => { answerCheck(ourOptions[2]) }}>{ourOptions[2]}</h3>
                        <h3 className='option1' onClick={() => { answerCheck(ourOptions[3]) }}>{ourOptions[3]}</h3>
