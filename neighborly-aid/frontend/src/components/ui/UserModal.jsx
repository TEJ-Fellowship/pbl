...
const UserModal = ({ isOpen = true, handleIsOpen = () => {} }) => {
  ...
  return (
    <>
      ...
      {/* Modal Container */}
      <div
        className={`fixed top-4 right-4 bottom-4 w-1/2 min-w-[550px] max-w-[650px] bg-blue-50 rounded-2xl shadow-xl border border-slate-200 z-50 transform transition-all duration-300 ease-out flex flex-col ${
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4 relative z-10">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold">
                {dashboardData.role === "helper"
                  ? "Your Impact in the Neighborhood"
          ...
          <div className="flex items-center space-x-4 relative z-10">
            ...
            <div>
              <h3 className="text-xl font-bold">{dashboardData.name}</h3>
              <p className="text-green-100 text-sm">{dashboardData.badges}</p>
